...
public class ModificationTest {
  ...
  public void modification() {
    ...
    driver.findElement(By.id("inputName")).sendKeys("Samsung");
    ...
    driver.findElement(By.cssSelector("tr:nth-child(2) .me-2")).click();
    driver.findElement(By.id("inputPrice")).click();
    driver.findElement(By.id("inputPrice")).sendKeys("1999999999999999999999");
    driver.findElement(By.id("btnAdd")).click();
    driver.findElement(By.cssSelector("tr:nth-child(2) .me-2")).click();
    driver.findElement(By.cssSelector("body")).click();
    driver.findElement(By.id("inputName")).sendKeys("Apple");
    driver.findElement(By.id("btnAdd")).click();
    driver.findElement(By.cssSelector("tr:nth-child(2) .text-danger")).click();
  }
}
