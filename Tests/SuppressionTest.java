...
public class SuppressionTest {
  ...
  public void suppression() {
    ...
    driver.manage().window().setSize(new Dimension(1260, 751));
    driver.findElement(By.id("btnClear")).click();
    driver.findElement(By.id("btnClear")).click();
    driver.findElement(By.id("btnClear")).click();
    driver.findElement(By.id("btnClear")).click();
    {
      WebElement element = driver.findElement(By.id("btnClear"));
    ...
    driver.findElement(By.id("btnClear")).click();
    driver.findElement(By.id("btnClear")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) .text-danger")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) .text-danger")).click();
    driver.findElement(By.cssSelector("tr:nth-child(1) .text-danger")).click();
